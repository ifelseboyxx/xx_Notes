...
#import "FDLabelViewController.h"
...
@interface FDLabelViewController () <UIActionSheetDelegate>
...
@implementation FDLabelViewController
...
- (void)viewDidLoad {
    ...
    _footer = [MJRefreshAutoNormalFooter footerWithRefreshingBlock:^{
        [weakSelf.feedEntitySections addObjectsFromArray:weakSelf.feedEntitySections];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    FDLabelCell *cell = [tableView dequeueReusableCellWithIdentifier:@"FDLabelCell"];
    [self configureCell:cell atIndexPath:indexPath];
    return cell;
}

- (void)configureCell:(FDLabelCell *)cell atIndexPath:(NSIndexPath *)indexPath {
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (mode) {
        case FDSimulatedCacheModeNone:
            return [tableView fd_heightForCellWithIdentifier:@"FDLabelCell" configuration:^(FDLabelCell *cell) {
                [self configureCell:cell atIndexPath:indexPath];
            }];
        case FDSimulatedCacheModeCacheByIndexPath:
            return [tableView fd_heightForCellWithIdentifier:@"FDLabelCell" cacheByIndexPath:indexPath configuration:^(FDLabelCell *cell) {
                [self configureCell:cell atIndexPath:indexPath];
            }];
        case FDSimulatedCacheModeCacheByKey: {
            FDFeedEntity *entity = self.feedEntitySections[indexPath.section][indexPath.row];
            
            return [tableView fd_heightForCellWithIdentifier:@"FDLabelCell" cacheByKey:entity.identifier configuration:^(FDLabelCell *cell) {
                [self configureCell:cell atIndexPath:indexPath];
            }];
        };
        default:
